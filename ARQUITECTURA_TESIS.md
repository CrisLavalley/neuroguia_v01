# Arquitectura de NeuroGuía para tesis

## Definición
NeuroGuía se concibe como un sistema conversacional de apoyo no clínico. Su valor no reside en el modelo de lenguaje en sí, sino en la arquitectura propia que orquesta seguridad, memoria contextual, recuperación de conocimiento validado, personalización por perfil y trazabilidad analítica.
...
Usa un motor de redacción controlada, restringido por reglas de seguridad y tono.
...
## Aporte de tesis
El aporte está en el diseño del sistema, no en la creación de un modelo base. Se propone una arquitectura especializada y segura para acompañamiento no clínico en contextos de neurodivergencia.
